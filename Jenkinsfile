pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = 'cithit/rimalgp'                                                                    //<------change this
        IMAGE_TAG = "build-${BUILD_NUMBER}"
        GITHUB_URL = 'https://github.com/Rimalgp/225-lab3-5.git'                                          //<------change this
        KUBECONFIG = credentials('rimalgp-test-credentials')                                                         //<------change this
    }
